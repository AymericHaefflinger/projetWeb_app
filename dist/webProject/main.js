...
module.exports = __webpack_require__(/*! /home/cnam/Documents/web/projet/git_app/frontend/src/main.ts */"zUnb");
...
class ProduitComponent {
    ...
    getData() {
        this.httpClient.get("https://projet-web-cnam-bdd.herokuapp.com/article/get", { headers: { 'content-type': 'application/x-www-form-urlencoded' } })
            .subscribe(data => {
